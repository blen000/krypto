...
const About = () => {
  return (
    <div className="bg-[url('../src/assets/c13.webp')] bg-no-repeat bg-cover flex flex-row items-center justify-center  mx-auto px-5 lg:px-10 py-10 lg:py-20 lg:mt-5">
          <div className="w-2/5 lg:w-2/5 mt-10 lg:mt-10 flex justify-center ">
      </div>
            <div className=" flex flex-row items-center justify-center h-auto mx-auto px-6 leading-8 p-8 text-justify">
